...
export default function HomeView({
  ...
  return (
    <div style={{
      ...
      {/* ========================================================
          1. SECTION 1: 4 KPI CARDS (2x2 Grid)
         ======================================================== */}
      <div className="home-kpi-grid">
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: '1.4rem', fontWeight: 900, color: '#0F172A', letterSpacing: '-0.02em', marginTop: '1px' }}>
      ...
      {/* ========================================================
          2. SECTION 2: SALES OVERVIEW + TOP SELLING ITEMS
         ======================================================== */}
      ...
      {/* ========================================================
          3. SECTION 3: RECENT ACTIVITY + QUICK ACTIONS
         ======================================================== */}
      <div className="home-dual-col">
        {/* Recent Activity */}
        <div style={{
      ...
      {/* ========================================================
          4. SECTION 4: FULL-WIDTH PRO PLAN BANNER
         ======================================================== */}
      <div style={{
        background: '#071F14',
        borderRadius: '18px',
      ...
      {/* ========================================================
          5. SECTION 5: FULL-WIDTH PLAN USAGE (3 COLUMNS)
         ======================================================== */}
      <div style={{
        background: '#FFFFFF',
        borderRadius: '18px',
      ...
      {/* ========================================================
          6. SECTION 6: FULL-WIDTH QUICK STATUS (2 COLUMNS)
         ======================================================== */}
      <div style={{
        background: '#FFFFFF',
        borderRadius: '18px',
      ...
      {/* ========================================================
          7. SECTION 7: FULL-WIDTH CELEBRATION BANNER
         ======================================================== */}
      <div style={{
        background: '#FEF9C3',
