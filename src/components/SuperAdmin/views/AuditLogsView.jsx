  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '14px', position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px', minWidth: 0 }}>
            ...
            <div>
              ...
              <p style={{ margin: '4px 0 0 0', fontSize: '0.78rem', color: '#A7F3D0', fontWeight: 600 }}>
                Immutable PostgreSQL security trail of all master actions, gateway webhooks, shop grants & tenant events.
              </p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
            ...
            >
              <RefreshCw size={14} className={loading ? 'spin' : ''} color="#0A2315" /> Refresh Trail
            </button>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ background: 'rgba(255,255,255,0.07)', padding: '10px 12px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.06)' }}>
            <div style={{ fontSize: '0.65rem', color: '#94A3B8', fontWeight: 800, textTransform: 'uppercase' }}>TOTAL EVENTS</div>
            <div style={{ fontSize: '0.90rem', fontWeight: 900, color: '#34D399', marginTop: '2px', fontVariantNumeric: 'tabular-nums' }}>
              📜 {stats.total} Logs
            </div>
          </div>

          <div style={{ background: 'rgba(255,255,255,0.07)', padding: '10px 12px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.06)' }}>
            <div style={{ fontSize: '0.65rem', color: '#94A3B8', fontWeight: 800, textTransform: 'uppercase' }}>SECURITY & ACCESS</div>
            <div style={{ fontSize: '0.90rem', fontWeight: 900, color: '#C084FC', marginTop: '2px', fontVariantNumeric: 'tabular-nums' }}>
              🔑 {stats.security} Events
            </div>
          </div>

          <div style={{ background: 'rgba(255,255,255,0.07)', padding: '10px 12px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.06)' }}>
            <div style={{ fontSize: '0.65rem', color: '#94A3B8', fontWeight: 800, textTransform: 'uppercase' }}>BILLING & CASHFREE</div>
            <div style={{ fontSize: '0.90rem', fontWeight: 900, color: '#6EE7B7', marginTop: '2px', fontVariantNumeric: 'tabular-nums' }}>
              💳 {stats.billing} Events
            </div>
          </div>

          <div style={{ background: 'rgba(255,255,255,0.07)', padding: '10px 12px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.06)' }}>
            <div style={{ fontSize: '0.65rem', color: '#94A3B8', fontWeight: 800, textTransform: 'uppercase' }}>SHOP LIFECYCLE</div>
            <div style={{ fontSize: '0.90rem', fontWeight: 900, color: '#93C5FD', marginTop: '2px', fontVariantNumeric: 'tabular-nums' }}>
              🏪 {stats.tenant} Events
            </div>
          </div>
        </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
        ...
        <div className="sa-filter-pills-strip" style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
          {[
            ...
            return (
              <button
                ...
                style={{
                  ...
                  padding: '7px 12px', fontWeight: 800, fontSize: '0.76rem',
              ...
              >
                <Icon size={13} color={isActive ? '#DFBA67' : 'currentColor'} />
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
          ...
          <select
            ...
            style={{
              padding: '7px 10px', borderRadius: '10px', border: '1px solid var(--sa-border)',
          ...
          <div style={{ position: 'relative', width: '230px' }}>
            ...
            <input
              ...
              style={{
                ...
                borderRadius: '10px', border: '1px solid var(--sa-border)',
                fontSize: '0.76rem', outline: 'none', background: '#FFFFFF'
              }}
            />
            {searchQuery && (
              <button
                ...
                style={{ position: 'absolute', right: '8px', top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', color: 'var(--sa-text-muted)', cursor: 'pointer', fontSize: '0.75rem' }}
              >
                ✕
              </button>
            )}
              ...
              {loading ? (
                <tr>
                  <td colSpan={6} style={{ textAlign: 'center', padding: '40px', color: 'var(--sa-text-muted)' }}>
                    ⏳ Loading live immutable audit log stream...
                  </td>
                </tr>
